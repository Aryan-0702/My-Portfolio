  ...
  return (
    <section>
      ...
      <div className="space-y-6">
        ...
        <div>
          <h3 className="text-lg font-semibold mb-3">JavaScript Library</h3>
          <div className="space-y-3">
        ...
        <div>
          <h3 className="text-lg font-semibold mb-3">Front-end Framework</h3>
          <div className="space-y-3">
        ...
        <div>
          <h3 className="text-lg font-semibold mb-3">SEO & WordPress Skills</h3>
          <div className="space-y-3">
